...
- Slope of the record's values versus the distance-weighted values of their neighbors.
...
```{r, out.width="100%", out.height="100%", message = FALSE, error = FALSE, warning = FALSE, echo = FALSE, results = "hide"}
