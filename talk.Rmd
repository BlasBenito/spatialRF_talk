...
```{r echo=FALSE, out.height="20%", out.width= "100%", eval = FALSE}
...
```{r, out.width="120%", out.height="60%", message = FALSE, error = FALSE, warning = FALSE, echo = FALSE, results = "hide"}
...
```{r, fig.height=9, fig.width=13, message = FALSE, error = FALSE, warning = FALSE, echo = FALSE, results = "hide"}
...
knitr::include_graphics("figures/latitude.png")
```
...
```{r echo=FALSE, out.height="60%", out.width= "100%"}
knitr::include_graphics("figures/aridity.png")
```
...
```{r echo=FALSE, out.height="60%", out.width= "100%"}
knitr::include_graphics("figures/accessibility.png")
```
...
```{r echo=FALSE, out.height="60%", out.width= "100%"}
knitr::include_graphics("figures/human_footprint.png")
```
...
```{r echo=FALSE, out.height="60%", out.width= "100%"}
knitr::include_graphics("figures/slope.png")
```
...
- Proximity among trees in a forest due to short distance dispersal.
...
# But spatial autocorrelation <br> also depends on how <br> we look at the world
